...
PS_IN VSMain(VS_IN input, uint id: SV_VertexID)
{
    ...
    const int FORCE_DRAW_SCREEN_ALIGNED_SQUAD = 1;

    PS_IN output = (PS_IN) 0;
 
    if (ls.sourceType == AMBIENT_LIGHT || ls.sourceType == DIRECTIONAL_LIGHT || constData.flags == FORCE_DRAW_SCREEN_ALIGNED_SQUAD)
    {
